...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if(confirm()){
                $.post("${pageContext.request.contextPath}/student/deleteStudentByIds",{"ids":studentIds},function (data) {
                    alert(data.msg)
         ...
         $("#addstudentbutton").click(function () {
            ...
            $("#addstudent").click(function () {
                var student=$("#addStudent").serialize();
                $.get("${pageContext.request.contextPath}/student/addStudent",student,
                function (data) {
                    alert(data.msg)
