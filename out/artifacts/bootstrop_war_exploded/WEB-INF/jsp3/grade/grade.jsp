                ...
                <div class="modal-body" >
                    <form id="addGradeForm">
                        <div class="form-group">
                            <label >班级名称：</label>
                            <input type="text"  name="gradeName" placeholder="班级名称" readonly>
                        </div>
                        <div class="form-group">
                            <label>班级描述：</label>
                ...
                <div class="modal-body" >
                    <form id="updateGradeForm">
                        <div class="form-group">
                            ...
                            <label >班级名称：</label>
                            <input type="text" id="updateGradeName" name="gradeName" placeholder="班级名称" readonly>
                        </div>
                        <div class="form-group">
                            <label>班级描述：</label>
                            <textarea class="form-control" id="updateDetails" rows="3" name="details" placeholder="班级描述"></textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
