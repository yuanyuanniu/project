...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if(confirm()){
                $.post("${pageContext.request.contextPath}/student/deleteStuentByIds",{"ids":studentIds}
                ,function (data) {
                    alert(data.msg);
            ...
            $("#addStudentButton").click(function () {
                ...
                $.get("${pageContext.request.contextPath}/student/addStudent",function (data) {
                    for(var i=0;i<data.length;i++){
                        $("#addStudentGradeSelect").append("<option value="+data[i].id+">"+
                        data.grade.grade_name+"</option>")
                    }
            ...
            $("#addStudent").click(function () {
                ...
                $.post("${pageContext.requst.contextPath}/student/addStudent",student,function (data) {
                    alert(data.msg)
