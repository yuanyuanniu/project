    ...
    <script type="text/javascript">
       $(function () {
        ...
        $.each($("input:checkbox"),function () {
           ...
           if(confirm()){
               $.post("${pageContext.request.contextPath}/student/deleteStduentByIds",{"ids":studentIds},function (data) {
                   alert(data.msg)
           ...
           $("#addStudentButton").click(function () {
               ...
               $.get("${pageContext.request.contextPath}/grade/qyeryAllGrade",function (data) {
